...
<body>
    <section NAV>
        ...
        <nav class="nav flex flex-sm-row border border justify-content-center mb-4">
            <a class="text-sm-center text-dark nav-link" href="?cat=all">ALL</a>
            <a class="text-sm-center text-dark nav-link" href="?cat=men">MEN</a>
            <a class="text-sm-center text-dark nav-link" href="?cat=women">WOMEN</a>
        </nav>
    </section>
