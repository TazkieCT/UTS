                ...
                <div class="col-12 border border p-2"> <?php include "koneksi.php"; ?>
                    ...
                    <table class="table table-responsive text-center">
                        ...
                        while ($transaksi = mysqli_fetch_array($query)) {
                            ...
                            echo "<td class='col-2'><a href='produk-edit.php?id=" . $transaksi['idpenjualan'] . "'class='btn btn-success'>Edit</a> ";
                            echo "<a href='produk-hapus.php?id=" . $transaksi['idpenjualan'] . "'class='btn btn-danger'>Hapus</a> ";
                            echo "</td>";
                            $no++;
                        }
                        ?>
